...
- A set of boss battles unlock after defeating Noland for the first time - some of your favourite trainers have come to the Battle Factory to challenge you!
- Optional battle speedup (adapted from [Pokémon Emerald Rogue](https://github.com/Pokabbie/pokeemerald-rogue))
- Instant text option
- Overworld speedup options
- Start game immediately outside Battle Factory

# Credits
- RHH for the amazing pokeemerald-expansion, which this project is built on (current using 1.15)
