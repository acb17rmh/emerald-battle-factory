...
// Compatibility aliases (used by auto-generated trainer data headers).
#define TRAINER_PIC_HIKER                  TRAINER_PIC_FRONT_HIKER
#define TRAINER_PIC_AQUA_GRUNT_M           TRAINER_PIC_FRONT_AQUA_GRUNT_M
#define TRAINER_PIC_POKEMON_BREEDER_F      TRAINER_PIC_FRONT_POKEMON_BREEDER_F
#define TRAINER_PIC_COOLTRAINER_M          TRAINER_PIC_FRONT_COOLTRAINER_M
#define TRAINER_PIC_BIRD_KEEPER            TRAINER_PIC_FRONT_BIRD_KEEPER
#define TRAINER_PIC_COLLECTOR              TRAINER_PIC_FRONT_COLLECTOR
#define TRAINER_PIC_AQUA_GRUNT_F           TRAINER_PIC_FRONT_AQUA_GRUNT_F
#define TRAINER_PIC_SWIMMER_M              TRAINER_PIC_FRONT_SWIMMER_M
#define TRAINER_PIC_MAGMA_GRUNT_M          TRAINER_PIC_FRONT_MAGMA_GRUNT_M
#define TRAINER_PIC_EXPERT_M               TRAINER_PIC_FRONT_EXPERT_M
#define TRAINER_PIC_AQUA_ADMIN_M           TRAINER_PIC_FRONT_AQUA_ADMIN_M
#define TRAINER_PIC_BLACK_BELT             TRAINER_PIC_FRONT_BLACK_BELT
#define TRAINER_PIC_AQUA_ADMIN_F           TRAINER_PIC_FRONT_AQUA_ADMIN_F
#define TRAINER_PIC_AQUA_LEADER_ARCHIE     TRAINER_PIC_FRONT_AQUA_LEADER_ARCHIE
#define TRAINER_PIC_HEX_MANIAC             TRAINER_PIC_FRONT_HEX_MANIAC
#define TRAINER_PIC_AROMA_LADY             TRAINER_PIC_FRONT_AROMA_LADY
#define TRAINER_PIC_RUIN_MANIAC            TRAINER_PIC_FRONT_RUIN_MANIAC
#define TRAINER_PIC_INTERVIEWER            TRAINER_PIC_FRONT_INTERVIEWER
#define TRAINER_PIC_TUBER_F                TRAINER_PIC_FRONT_TUBER_F
#define TRAINER_PIC_TUBER_M                TRAINER_PIC_FRONT_TUBER_M
#define TRAINER_PIC_COOLTRAINER_F          TRAINER_PIC_FRONT_COOLTRAINER_F
#define TRAINER_PIC_LADY                   TRAINER_PIC_FRONT_LADY
#define TRAINER_PIC_BEAUTY                 TRAINER_PIC_FRONT_BEAUTY
#define TRAINER_PIC_RICH_BOY               TRAINER_PIC_FRONT_RICH_BOY
#define TRAINER_PIC_EXPERT_F               TRAINER_PIC_FRONT_EXPERT_F
#define TRAINER_PIC_POKEMANIAC             TRAINER_PIC_FRONT_POKEMANIAC
#define TRAINER_PIC_MAGMA_GRUNT_F          TRAINER_PIC_FRONT_MAGMA_GRUNT_F
#define TRAINER_PIC_GUITARIST              TRAINER_PIC_FRONT_GUITARIST
#define TRAINER_PIC_KINDLER                TRAINER_PIC_FRONT_KINDLER
#define TRAINER_PIC_CAMPER                 TRAINER_PIC_FRONT_CAMPER
#define TRAINER_PIC_PICNICKER              TRAINER_PIC_FRONT_PICNICKER
#define TRAINER_PIC_BUG_MANIAC             TRAINER_PIC_FRONT_BUG_MANIAC
#define TRAINER_PIC_POKEMON_BREEDER_M      TRAINER_PIC_FRONT_POKEMON_BREEDER_M
#define TRAINER_PIC_PSYCHIC_M              TRAINER_PIC_FRONT_PSYCHIC_M
#define TRAINER_PIC_PSYCHIC_F              TRAINER_PIC_FRONT_PSYCHIC_F
#define TRAINER_PIC_GENTLEMAN              TRAINER_PIC_FRONT_GENTLEMAN
#define TRAINER_PIC_ELITE_FOUR_SIDNEY      TRAINER_PIC_FRONT_ELITE_FOUR_SIDNEY
#define TRAINER_PIC_ELITE_FOUR_PHOEBE      TRAINER_PIC_FRONT_ELITE_FOUR_PHOEBE
#define TRAINER_PIC_ELITE_FOUR_GLACIA      TRAINER_PIC_FRONT_ELITE_FOUR_GLACIA
#define TRAINER_PIC_ELITE_FOUR_DRAKE       TRAINER_PIC_FRONT_ELITE_FOUR_DRAKE
#define TRAINER_PIC_LEADER_ROXANNE         TRAINER_PIC_FRONT_LEADER_ROXANNE
#define TRAINER_PIC_LEADER_BRAWLY          TRAINER_PIC_FRONT_LEADER_BRAWLY
#define TRAINER_PIC_LEADER_WATTSON         TRAINER_PIC_FRONT_LEADER_WATTSON
#define TRAINER_PIC_LEADER_FLANNERY        TRAINER_PIC_FRONT_LEADER_FLANNERY
#define TRAINER_PIC_LEADER_NORMAN          TRAINER_PIC_FRONT_LEADER_NORMAN
#define TRAINER_PIC_LEADER_WINONA          TRAINER_PIC_FRONT_LEADER_WINONA
#define TRAINER_PIC_LEADER_TATE_AND_LIZA   TRAINER_PIC_FRONT_LEADER_TATE_AND_LIZA
#define TRAINER_PIC_LEADER_JUAN            TRAINER_PIC_FRONT_LEADER_JUAN
#define TRAINER_PIC_SCHOOL_KID_M           TRAINER_PIC_FRONT_SCHOOL_KID_M
#define TRAINER_PIC_SCHOOL_KID_F           TRAINER_PIC_FRONT_SCHOOL_KID_F
#define TRAINER_PIC_SR_AND_JR              TRAINER_PIC_FRONT_SR_AND_JR
#define TRAINER_PIC_POKEFAN_M              TRAINER_PIC_FRONT_POKEFAN_M
#define TRAINER_PIC_POKEFAN_F              TRAINER_PIC_FRONT_POKEFAN_F
#define TRAINER_PIC_YOUNGSTER              TRAINER_PIC_FRONT_YOUNGSTER
#define TRAINER_PIC_CHAMPION_WALLACE       TRAINER_PIC_FRONT_CHAMPION_WALLACE
#define TRAINER_PIC_FISHERMAN              TRAINER_PIC_FRONT_FISHERMAN
#define TRAINER_PIC_CYCLING_TRIATHLETE_M   TRAINER_PIC_FRONT_CYCLING_TRIATHLETE_M
#define TRAINER_PIC_CYCLING_TRIATHLETE_F   TRAINER_PIC_FRONT_CYCLING_TRIATHLETE_F
#define TRAINER_PIC_RUNNING_TRIATHLETE_M   TRAINER_PIC_FRONT_RUNNING_TRIATHLETE_M
#define TRAINER_PIC_RUNNING_TRIATHLETE_F   TRAINER_PIC_FRONT_RUNNING_TRIATHLETE_F
#define TRAINER_PIC_SWIMMING_TRIATHLETE_M  TRAINER_PIC_FRONT_SWIMMING_TRIATHLETE_M
#define TRAINER_PIC_SWIMMING_TRIATHLETE_F  TRAINER_PIC_FRONT_SWIMMING_TRIATHLETE_F
#define TRAINER_PIC_DRAGON_TAMER           TRAINER_PIC_FRONT_DRAGON_TAMER
#define TRAINER_PIC_NINJA_BOY              TRAINER_PIC_FRONT_NINJA_BOY
#define TRAINER_PIC_BATTLE_GIRL            TRAINER_PIC_FRONT_BATTLE_GIRL
#define TRAINER_PIC_PARASOL_LADY           TRAINER_PIC_FRONT_PARASOL_LADY
#define TRAINER_PIC_SWIMMER_F              TRAINER_PIC_FRONT_SWIMMER_F
#define TRAINER_PIC_TWINS                  TRAINER_PIC_FRONT_TWINS
#define TRAINER_PIC_SAILOR                 TRAINER_PIC_FRONT_SAILOR
#define TRAINER_PIC_MAGMA_ADMIN            TRAINER_PIC_FRONT_MAGMA_ADMIN
#define TRAINER_PIC_WALLY                  TRAINER_PIC_FRONT_WALLY
#define TRAINER_PIC_BRENDAN                TRAINER_PIC_FRONT_BRENDAN
#define TRAINER_PIC_MAY                    TRAINER_PIC_FRONT_MAY
#define TRAINER_PIC_BUG_CATCHER            TRAINER_PIC_FRONT_BUG_CATCHER
#define TRAINER_PIC_POKEMON_RANGER_M       TRAINER_PIC_FRONT_POKEMON_RANGER_M
#define TRAINER_PIC_POKEMON_RANGER_F       TRAINER_PIC_FRONT_POKEMON_RANGER_F
#define TRAINER_PIC_MAGMA_LEADER_MAXIE     TRAINER_PIC_FRONT_MAGMA_LEADER_MAXIE
#define TRAINER_PIC_LASS                   TRAINER_PIC_FRONT_LASS
#define TRAINER_PIC_YOUNG_COUPLE           TRAINER_PIC_FRONT_YOUNG_COUPLE
#define TRAINER_PIC_OLD_COUPLE             TRAINER_PIC_FRONT_OLD_COUPLE
#define TRAINER_PIC_SIS_AND_BRO            TRAINER_PIC_FRONT_SIS_AND_BRO
#define TRAINER_PIC_STEVEN                 TRAINER_PIC_FRONT_STEVEN
#define TRAINER_PIC_SALON_MAIDEN_ANABEL    TRAINER_PIC_FRONT_SALON_MAIDEN_ANABEL
#define TRAINER_PIC_DOME_ACE_TUCKER        TRAINER_PIC_FRONT_DOME_ACE_TUCKER
#define TRAINER_PIC_PALACE_MAVEN_SPENSER   TRAINER_PIC_FRONT_PALACE_MAVEN_SPENSER
#define TRAINER_PIC_ARENA_TYCOON_GRETA     TRAINER_PIC_FRONT_ARENA_TYCOON_GRETA
#define TRAINER_PIC_FACTORY_HEAD_NOLAND    TRAINER_PIC_FRONT_FACTORY_HEAD_NOLAND
#define TRAINER_PIC_PIKE_QUEEN_LUCY        TRAINER_PIC_FRONT_PIKE_QUEEN_LUCY
#define TRAINER_PIC_PYRAMID_KING_BRANDON   TRAINER_PIC_FRONT_PYRAMID_KING_BRANDON
#define TRAINER_PIC_RED                    TRAINER_PIC_FRONT_RED
#define TRAINER_PIC_LEAF                   TRAINER_PIC_FRONT_LEAF
#define TRAINER_PIC_RS_BRENDAN             TRAINER_PIC_FRONT_RS_BRENDAN
#define TRAINER_PIC_RS_MAY                 TRAINER_PIC_FRONT_RS_MAY
#define TRAINER_PIC_BLUE                   TRAINER_PIC_FRONT_BLUE
#define TRAINER_PIC_CYNTHIA                TRAINER_PIC_FRONT_CYNTHIA

// Old back pic IDs (use TRAINER_PIC_BACK_* directly where possible).
#define TRAINER_BACK_PIC_BRENDAN               TRAINER_PIC_BACK_BRENDAN
#define TRAINER_BACK_PIC_MAY                   TRAINER_PIC_BACK_MAY
#define TRAINER_BACK_PIC_RED                   TRAINER_PIC_BACK_RED
#define TRAINER_BACK_PIC_LEAF                  TRAINER_PIC_BACK_LEAF
#define TRAINER_BACK_PIC_RUBY_SAPPHIRE_BRENDAN TRAINER_PIC_BACK_RUBY_SAPPHIRE_BRENDAN
#define TRAINER_BACK_PIC_RUBY_SAPPHIRE_MAY     TRAINER_PIC_BACK_RUBY_SAPPHIRE_MAY
#define TRAINER_BACK_PIC_WALLY                 TRAINER_PIC_BACK_WALLY
#define TRAINER_BACK_PIC_STEVEN                TRAINER_PIC_BACK_STEVEN
