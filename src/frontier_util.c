...
static const u8 sText_DefaultFactoryBossCall[] = _(
    "There is a message from a powerful\n"
    "TRAINER.\p"
    "Come to the battle room right now.");
static const u8 sText_DefaultFactoryBossIntro[] = _(
    "A powerful TRAINER appears before you!");
static const u8 sText_DefaultFactoryBossBattleRoomPrompt[] = _(
    "Hey, hey!\n"
    "Get a move on!");
static const u8 sText_DefaultFactoryBossPostWin[] = _(
    "Well done.\n"
    "That was an excellent battle.");
static const u8 sText_FactoryBossName_None[] = _("No one");
static const u8 sText_DefaultFactoryBossScoutHint[] = _(
    "Breaking news!\p"
