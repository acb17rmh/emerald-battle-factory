...
const u8 gText_BattleFactoryReward[] = _("You've beaten the Battle Factory!\nSelect a POKéMON to keep as a reward.");
...
const u8 gText_OverworldSpeed[] = _("OVERWORLD SPEED");
...
const u8 gText_OptionMenuLRToChangePage[] = _("{L_BUTTON}{R_BUTTON}");
const u8 gText_OptionMenuCategoryGeneral[] = _("GENERAL");
const u8 gText_OptionMenuCategoryBattle[] = _("BATTLE");
const u8 gText_OptionMenuCategorySpeed[] = _("SPEED");
const u8 gText_OptionMenuCategorySystem[] = _("SYSTEM");
...
const u8 gText_BattleSpeedOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}1x");
...
const u8 gText_OverworldSpeed1x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}1x");
const u8 gText_OverworldSpeed2x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}2x");
const u8 gText_OverworldSpeed4x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}4x");
const u8 gText_OverworldSpeed8x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}8x");
