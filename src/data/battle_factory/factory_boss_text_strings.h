...
static const u8 sText_StevenPreBattleCall[] = COMPOUND_STRING(
    "Report from the floor: STEVEN has\n"
    "entered the arena.\p"
...
static const u8 sText_StevenBattlePostWin[] = COMPOUND_STRING(
    "Excellent battle.\p"
    "You stayed calm, read the field,\n"
    "and made every turn count.");
...
static const u8 sText_NormanPreBattleCall[] = COMPOUND_STRING(
    "News flash: NORMAN is in the\n"
    "building and looking fired up.\p"
    "He says this one won't be gentle.");
...
static const u8 sText_NormanBattlePostWin[] = COMPOUND_STRING(
    "Hah! That's the spirit.\p"
    "You fought with nerve and discipline.\n"
    "That's what wins tough matches.");
...
static const u8 sText_WallyPreBattleCall[] = COMPOUND_STRING(
    "A call just came in from WALLY.\p"
    "He's waiting in the arena and says\n"
    "he wants to show his true strength.");
...
static const u8 sText_WallyBattlePostWin[] = COMPOUND_STRING(
    "That was amazing...\p"
    "Battling you teaches me something\n"
    "new every time.");
